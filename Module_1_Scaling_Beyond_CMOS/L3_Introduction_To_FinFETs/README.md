...
| Next → | [L4 — FinFET Circuit Design Basics](../L4/README.md) |The gate only controls the channel from the **top**. Current leaks through the deeper sub-channel region (red arrow), causing high off-state leakage.
</details>
